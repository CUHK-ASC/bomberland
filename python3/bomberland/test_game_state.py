...
def create_mock_tick_packet(tick_number, events):
    return {
        "type": "tick",
        "payload": {"tick": tick_number, "events": copy_object(events)},
    }
...
mock_state = {
    ...
    "entities": [
        {"created": 0, "x": 11, "y": 7, "type": "m"},
        {"created": 0, "x": 3, "y": 7, "type": "m"},
        {"created": 0, "x": 10, "y": 11, "type": "m"},
        {"created": 0, "x": 4, "y": 11, "type": "m"},
        {"created": 0, "x": 11, "y": 2, "type": "m"},
        {"created": 0, "x": 3, "y": 2, "type": "m"},
        {"created": 0, "x": 4, "y": 8, "type": "m"},
        {"created": 0, "x": 10, "y": 8, "type": "m"},
        ...
        {"created": 0, "x": 0, "y": 0, "type": "m"},
        {"created": 0, "x": 2, "y": 3, "type": "m"},
        {"created": 0, "x": 12, "y": 3, "type": "m"},
        ...
        {"created": 0, "x": 11, "y": 13, "type": "m"},
        {"created": 0, "x": 3, "y": 13, "type": "m"},
        {"created": 0, "x": 2, "y": 10, "type": "m"},
        {"created": 0, "x": 12, "y": 10, "type": "m"},
        {"created": 0, "x": 2, "y": 13, "type": "m"},
        {"created": 0, "x": 12, "y": 13, "type": "m"},
        {"created": 0, "x": 12, "y": 6, "type": "m"},
        {"created": 0, "x": 2, "y": 6, "type": "m"},
        {"created": 0, "x": 1, "y": 10, "type": "m"},
        {"created": 0, "x": 13, "y": 10, "type": "m"},
        {"created": 0, "x": 1, "y": 6, "type": "m"},
        {"created": 0, "x": 13, "y": 6, "type": "m"},
        {"created": 0, "x": 9, "y": 12, "type": "m"},
        {"created": 0, "x": 5, "y": 12, "type": "m"},
        {"created": 0, "x": 1, "y": 0, "type": "m"},
        {"created": 0, "x": 13, "y": 0, "type": "m"},
        {"created": 0, "x": 14, "y": 2, "type": "m"},
        {"created": 0, "x": 0, "y": 2, "type": "m"},
        ...
        {"created": 0, "x": 12, "y": 5, "type": "m"},
        {"created": 0, "x": 2, "y": 5, "type": "m"},
        {"created": 0, "x": 1, "y": 3, "type": "w", "hp": 1},
        {"created": 0, "x": 13, "y": 3, "type": "w", "hp": 1},
        {"created": 0, "x": 1, "y": 8, "type": "w", "hp": 1},
        {"created": 0, "x": 13, "y": 8, "type": "w", "hp": 1},
        ...
        {"created": 0, "x": 5, "y": 9, "type": "w", "hp": 1},
        {"created": 0, "x": 9, "y": 9, "type": "w", "hp": 1},
        {"created": 0, "x": 3, "y": 1, "type": "w", "hp": 1},
        {"created": 0, "x": 11, "y": 1, "type": "w", "hp": 1},
        ...
        {"created": 0, "x": 10, "y": 13, "type": "w", "hp": 1},
        {"created": 0, "x": 4, "y": 13, "type": "w", "hp": 1},
        {"created": 0, "x": 14, "y": 13, "type": "w", "hp": 1},
        {"created": 0, "x": 0, "y": 13, "type": "w", "hp": 1},
        {"created": 0, "x": 10, "y": 14, "type": "w", "hp": 1},
        {"created": 0, "x": 4, "y": 14, "type": "w", "hp": 1},
        {"created": 0, "x": 5, "y": 3, "type": "w", "hp": 1},
        {"created": 0, "x": 9, "y": 3, "type": "w", "hp": 1},
        {"created": 0, "x": 2, "y": 11, "type": "w", "hp": 1},
        {"created": 0, "x": 12, "y": 11, "type": "w", "hp": 1},
        {"created": 0, "x": 10, "y": 2, "type": "w", "hp": 1},
        {"created": 0, "x": 4, "y": 2, "type": "w", "hp": 1},
        {"created": 0, "x": 9, "y": 0, "type": "w", "hp": 1},
        {"created": 0, "x": 5, "y": 0, "type": "w", "hp": 1},
        {"created": 0, "x": 1, "y": 4, "type": "w", "hp": 1},
        {"created": 0, "x": 13, "y": 4, "type": "w", "hp": 1},
        {"created": 0, "x": 1, "y": 2, "type": "w", "hp": 1},
        {"created": 0, "x": 13, "y": 2, "type": "w", "hp": 1},
        {"created": 0, "x": 8, "y": 5, "type": "w", "hp": 1},
        {"created": 0, "x": 6, "y": 5, "type": "w", "hp": 1},
        {"created": 0, "x": 6, "y": 2, "type": "w", "hp": 1},
        {"created": 0, "x": 8, "y": 2, "type": "w", "hp": 1},
        {"created": 0, "x": 0, "y": 4, "type": "w", "hp": 1},
        {"created": 0, "x": 14, "y": 4, "type": "w", "hp": 1},
        {"created": 0, "x": 13, "y": 1, "type": "w", "hp": 1},
        {"created": 0, "x": 1, "y": 1, "type": "w", "hp": 1},
        {"created": 0, "x": 5, "y": 14, "type": "w", "hp": 1},
        {"created": 0, "x": 9, "y": 14, "type": "w", "hp": 1},
        ...
        {"created": 0, "x": 11, "y": 3, "type": "o", "hp": 3},
        {"created": 0, "x": 3, "y": 3, "type": "o", "hp": 3},
    ...
    "connection": {"id": 2, "role": "agent", "agent_id": "b"},
}

mock_state_packet = {"type": "game_state", "payload": copy_object(mock_state)}


mock_tick_spawn_packet = create_mock_tick_packet(
    22,
    [
        {
            "type": "entity_spawned",
...
mock_tick_expired_packet = create_mock_tick_packet(
    62, [{"type": "entity_expired", "data": [7, 3]}]
)

mock_unit_state_payload = {
    "coordinates": [3, 10],
    "hp": 3,
    "inventory": {"bombs": 2},
    "blast_diameter": 3,
...
mock_tick_unit_state_packet = create_mock_tick_packet(
    50, [{"type": "unit_state", "data": mock_unit_state_payload}]
)
    ...
    [
        {
            "type": "unit",
            "agent_id": "a",
            "data": {"type": "move", "move": "right", "unit_id": "c"},
        }
    ],
)
...
class TestGameState(IsolatedAsyncioTestCase):
    ...
    def test_mocks_are_valid_with_latest_schema(self):
        with open("validation.schema.json") as f:
            schema = json.load(f)
            validate(
                instance=mock_state_packet,
                schema=schema.get("definitions").get("ValidServerPacket"),
            )

            validate(
                instance=mock_tick_spawn_packet,
                schema=schema.get("definitions").get("ValidServerPacket"),
            )

            validate(
                instance=mock_tick_unit_action_packet,
                schema=schema.get("definitions").get("ValidServerPacket"),
            )

            validate(
                instance=mock_tick_unit_state_packet,
                schema=schema.get("definitions").get("ValidServerPacket"),
            )
